...
int tpFlipDetGauche[6] = { 0x30, 0x38, 0x7C, 0x7F, 0x73, 0x60 };
int tpFlipDetDroit[6]  = { 0x0C, 0x1C, 0x3E, 0xFE, 0xCE, 0x06 };
...
// ahead of its first call site (tpFalseBall() below), matching this
// file's own convention of defining helpers immediately before their
// first use.
#define TP_SFX_MAX_NOTES 13
float tpSfxFreq[TP_SFX_MAX_NOTES];
float tpSfxDur[TP_SFX_MAX_NOTES];
int tpSfxLen;
int tpSfxPos;
int tpSfxWaitFrames;
