...
int trogOneEnm[10] = { 8,1, 0,56,124,124,124,124,56,0, };
int trogOneBlock[8] = { 95,111,126,125,127,127,54,0, };
int trogOneDown[8]  = { 255,129,249,129,225,129,193,255, };
int trogOneKey[8]   = { 0,0,6,122,106,6,0,0, };
int trogOneBox[8]   = { 0,124,5,85,109,124,0,0, };
...
int trogTileMap[11][17]; // [y][x], sized to the true max (11 rows x 17 cols)

TrogNumDisp trogHpDisp;
TrogNumDisp trogStageDisp;

TrogEnemy trogEnemies[5];
...
int trogOverlayRowBuffer[128];
int trogEnmScreenX[5];
int trogEnmScreenY[5];
int trogEnmOffsetX[5];
int trogEnmOffsetY[5];
