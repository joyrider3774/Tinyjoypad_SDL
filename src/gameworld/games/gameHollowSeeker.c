...
int hsImgCave[8] = { 0x90, 0x06, 0x4E, 0xE4, 0xC0, 0x88, 0x18, 0x99 };
...
int hsSoundStart[11] = { 72, 12, 74, 12, 76, 12, 77, 12, 79, 36, 0xFF };
int hsSoundOver[17]  = { 55, 13, 54, 16, 53, 19, 52, 22, 51, 25, 50, 28, 49, 31, 48, 34, 0xFF };
...
HsColumn hsCaveColumn[HS_COLUMNS];
int hsState;
