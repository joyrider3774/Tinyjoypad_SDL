...
//   the "hold fire 2s to reset high score" secret menu action now resets
//   the real persisted value too, not just the in-memory one.
// =============================================================================
...
int wrenTextByte( int x, int y, int startX, int pageY, char* str )
{
    if( y != pageY ) return 0;
