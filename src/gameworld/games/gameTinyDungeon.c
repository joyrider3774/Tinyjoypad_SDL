...
int tdngNibbleBitCount[16] =
{
0,1,1,2,1,2,2,3,1,2,2,3,2,3,3,4,
};

int tdngScalingFactorFromDistance[4] =
{
0,1,2,4,
};

int tdngVerticalStartOffset[4] =
{
0,0,2,3,
};

int tdngVerticalEndOffset[4] =
{
0,7,5,4,
};

int tdngBitMaskFromScalingFactor[5] =
{
0,1,3,0,15,
};

int tdngLightingTable[16] =
{
255,255,255,255,85,170,136,36,0,0,0,0,0,0,0,0,
};

int tdngObjectCenterPositions[12] =
{
-127,48,127,-19,48,115,18,48,78,33,48,63,
};

int tdngLevel1Init[256] =
{
...
int tdngStatusPanelVertical[256] =
{
...
int tdngLeftRightWallsD3[20] =
{
228,0,220,54,128,22,208,8,176,10,176,10,192,10,24,22,
236,52,104,54,
};

int tdngOuterLeftRightWallsD2[120] =
{
...
int tdngOuterLeftRightWallsD3[60] =
{
...
int tdngMatchedWallIdx[24];

int tdngVisObjCount;
int tdngVisObjDistance[99];
int tdngVisObjN[99];
int tdngVisObjOffset[99];
int tdngVisObjWidth[99];
int tdngVisObjOnWall[99];
int tdngVisObjLR[99];
