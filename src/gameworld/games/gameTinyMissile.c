...
int tmisSnd0Notes[4] = { 100, 250, 20, 250 };
int tmisSnd3Notes[4] = { 200, 140, 100, 140 };
int tmisSnd4Notes[4] = { 2, 140, 200, 14 };
int tmisSnd5Notes[4] = { 200, 6, 150, 6 };
...
// time: 210,165,120,75.
int tmisDestroyNotes[8] = { 210, 4, 165, 4, 120, 4, 75, 4 };
...
int tmisWinLevelNotes[128];
int tmisGameOverNotes[96];
