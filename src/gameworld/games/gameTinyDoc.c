...
int tdAutoTrigL;
int tdAutoTrigR;
int tdVirusTypeActif[3];
int tdTab[8][10];
int tdBackCheck[8][10];
...
int tdSndFreqBytes[TD_SND_MAX_NOTES];
int tdSndDurBytes[TD_SND_MAX_NOTES];
int tdSndLen;
int tdSndPos;
int tdSndWaitFrames;
