...
int flpyWallTile[8] = { 0xFF, 0x81, 0x95, 0xA9, 0x89, 0xD1, 0x85, 0xFF };
int flpyBirdTile[8] = { 0x78, 0x84, 0x82, 0x81, 0xC9, 0x22, 0x24, 0x18 };

// Game-over screen (128x64, standard row-major page order) - byte-diff-
// verified against upstream's own GameOver[].
int flpyGameOver[1024] =
{
...
int flpyTextByteAt( char* text, int textLen, int startX, int x )
{
