...
int gldBlocks[7] = { 17476, 17600, 17504, 1632, 1728, 3648, 3168, };

int gldBlockout[16] = { 248, 0, 62, 128, 15, 224, 3, 248, 62, 128, 15, 224, 3, 248, 62, 0, };
int gldGhostout[16]  = { 136, 0, 34, 128, 8, 32, 2, 136, 34, 128, 8, 32, 2, 136, 34, 0, };

int gldBrickLogo[288] =
{
...
int gldCharByte( char* str, int strLen, int startPage, int startCol, int physPage, int physCol )
{
...
bool gldBlockGrid[10][24];
bool gldGhostGrid[10][24];

int gldNextBlockBuffer[8][2];
int gldNextPiece;
int gldScore;
int gldTop;
int gldLevel;
