...
//
// On-screen text: every upstream C-string literal ("Level ", "x Bullets",
// "Level Complete", "Score: ", "High Score: ", "New High Score",
// "Game Over", "Game Complete") is ported as a named int[] character-code
// array instead (`barrTxt*` below) rather than passed as a literal - a raw
// C string literal handed to the existing int*-typed text-buffer helpers
// (barrSetText/barrSetTextPlusNumber/barrSetNumberPlusText/barrTextByteAt,
// all designed around Vircon32's own int[]-per-character string dialect)
// would misread its packed single-byte characters as garbage 4-byte
// values - matching this project's own established convention for on-screen
// text elsewhere (see e.g. gameOroboros.c's orbTxtTitle/orbTxtGameOver).
// =============================================================================
...
// Named int[] character-code arrays replacing upstream's raw C-string
// literals - see this file's own header comment.
int barrTxtLevel[6]          = { 'L','e','v','e','l',' ' };
int barrTxtXBullets[9]       = { 'x',' ','B','u','l','l','e','t','s' };
int barrTxtLevelComplete[14] = { 'L','e','v','e','l',' ','C','o','m','p','l','e','t','e' };
int barrTxtScorePrefix[7]    = { 'S','c','o','r','e',':',' ' };
int barrTxtHighScorePrefix[12] = { 'H','i','g','h',' ','S','c','o','r','e',':',' ' };
int barrTxtNewHighScore[14]  = { 'N','e','w',' ','H','i','g','h',' ','S','c','o','r','e' };
int barrTxtGameOver[9]       = { 'G','a','m','e',' ','O','v','e','r' };
int barrTxtGameComplete[13]  = { 'G','a','m','e',' ','C','o','m','p','l','e','t','e' };
...
int barrLargeTarget[128] = // 32x32 (4 pages x 32 cols)
{
...
int barrMediumTarget[32] = // 16x16 (2 pages x 16 cols)
{
...
int barrSmallTarget[8] = { 0x00, 0x3c, 0x42, 0x5a, 0x5a, 0x42, 0x3c, 0x00 }; // 8x8

int barrPlayer[8] = { 0xc0, 0xe0, 0xf0, 0xc0, 0xc0, 0xf0, 0xe0, 0xc0 }; // 8x8

int barrBullet[2] = { 0x3c, 0x3c }; // 2x8
...
int barrStartupNotes[6]        = { 261,100, 329,100, 391,250 };
int barrLevelCompleteNotes[8]  = { 261,100, 349,100, 440,100, 523,250 };
int barrHighScoreNotes[8]      = { 261,200, 0,100, 261,200, 391,500 };
int barrGameCompleteNotes[10]  = { 261,100, 329,100, 391,100, 492,100, 523,250 };
int barrGameOverNotes[4]       = { 370,100, 261,250 };
...
{
    barrScoreLineLen = barrSetTextPlusNumber( barrScoreLine, barrTxtScorePrefix, 7, barrScore );
    barrHighLineLen = barrSetTextPlusNumber( barrHighLine, barrTxtHighScorePrefix, 12, barrTopScore );
}
...
void barrBeginLevelIntro( int levelNo )
{
    ...
    barrClearScreenText();
    barrTitleLineLen = barrSetTextPlusNumber( barrTitleLine, barrTxtLevel, 6, levelNo );
    barrTitleLineCol = 40; barrTitleLinePage = 4;
    barrSubLineLen = barrSetNumberPlusText( barrSubLine, barrBulletsLeft, barrTxtXBullets, 9 );
...
void barrBeginLevelComplete()
{
    ...
    barrClearScreenText();
    barrTitleLineLen = barrSetText( barrTitleLine, barrTxtLevelComplete, 14 );
...
void barrBeginNewHigh( int afterState )
{
    ...
    barrClearScreenText();
    barrTitleLineLen = barrSetText( barrTitleLine, barrTxtNewHighScore, 14 );
    barrTitleLineCol = 16; barrTitleLinePage = 3;
    int hlen = barrSetTextPlusNumber( barrHighLine, barrTxtHighScorePrefix, 12, barrTopScore );
    int i;
...
{
    barrClearScreenText();
    barrTitleLineLen = barrSetText( barrTitleLine, barrTxtGameOver, 9 );
...
{
    barrClearScreenText();
    barrTitleLineLen = barrSetText( barrTitleLine, barrTxtGameComplete, 13 );
