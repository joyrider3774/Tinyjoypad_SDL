...
int jslmCoin0[10]    = { 8, 1, 0x00, 0x3e, 0x63, 0x5d, 0x5d, 0x7f, 0x3e, 0x00 };
int jslmCoin1[10]    = { 8, 1, 0x00, 0x3e, 0x7f, 0x5d, 0x5d, 0x63, 0x3e, 0x00 };
int jslmBlock0[10]   = { 8, 1, 0x7e, 0x81, 0xbd, 0x85, 0x85, 0x85, 0xc1, 0x7e };
int jslmBlock1[10]   = { 8, 1, 0x7e, 0x81, 0xa5, 0x81, 0x81, 0xa5, 0x81, 0x7e };
int jslmChLeft0[10]  = { 8, 1, 0x70, 0xd8, 0xfc, 0xfc, 0xdc, 0xfc, 0xf8, 0x70 };
int jslmChLeft1[10]  = { 8, 1, 0x38, 0x6c, 0xfe, 0xfe, 0xee, 0xfe, 0x7c, 0x38 };
int jslmChRight0[10] = { 8, 1, 0x70, 0xf8, 0xfc, 0xdc, 0xfc, 0xfc, 0xd8, 0x70 };
int jslmChRight1[10] = { 8, 1, 0x38, 0x7c, 0xfe, 0xee, 0xfe, 0xfe, 0x6c, 0x38 };
int jslmEnemySyuriken0[10] = { 8, 1, 0x40, 0x19, 0x34, 0x46, 0x62, 0x2c, 0x98, 0x02 };
int jslmEnemySyuriken1[10] = { 8, 1, 0x06, 0x98, 0xac, 0x62, 0x46, 0x35, 0x19, 0x60 };
...
int jslmEnemyMountain[10] = { 8, 1, 0xf0, 0xdc, 0xe3, 0x8e, 0xc4, 0x98, 0xe0, 0x00 };
...
int jslmStage1Blocks[36] = { 8,4,0, 13,4,0, 0,5,0, 1,5,0, 2,5,0, 3,5,0, 5,5,0, 6,5,0, 10,5,0, 11,5,0, 12,5,0, 15,5,0, };
int jslmStage2Blocks[39] = { 6,2,0, 8,3,0, 9,3,0, 5,4,0, 11,4,0, 0,5,0, 1,5,0, 3,5,0, 10,5,0, 8,6,0, 6,7,0, 15,2,0, 13,3,0, };
int jslmStage3Blocks[36] = { 8,4,0, 13,4,0, 0,5,0, 1,5,0, 2,5,0, 3,5,0, 5,5,0, 6,5,0, 10,5,0, 11,5,0, 12,5,0, 15,5,0, };
int jslmStage4Blocks[39] = { 6,2,0, 8,3,0, 9,3,0, 5,4,0, 11,4,0, 0,5,0, 1,5,0, 3,5,0, 10,5,0, 8,6,0, 6,7,0, 15,2,0, 13,3,0, };
int jslmStage5Blocks[27] = { 7,3,0, 5,4,0, 0,5,0, 1,5,0, 3,5,0, 13,6,0, 15,5,0, 10,7,0, 11,7,0, };

int jslmNumBlocks[5] = { 12, 13, 12, 13, 9, };

int jslmStage3Enemies[14] = { 10,4,0,80,32,20,32,  4,6,0,30,48,90,48, };
int jslmStage4Enemies[7]  = { 7,5,0,50,40,100,40, };
int jslmStage5Enemies[14] = { 6,3,0,16,24,48,24,  11,6,0,48,48,88,48, };

int jslmNumEnemies[5] = { 0, 0, 2, 1, 2, };

int jslmGoalPosi[10] = { 120,40, 48,16, 120,40, 48,16, 120,40, };
...
int jslmStgLabel[16] = { 0xb8, 0xe8, 0, 8, 0xf8, 8, 0xf0, 0x28, 0xf0, 0, 0x70, 0x88, 0xc8, 0, 0xf8, 0xa8, };
...
// Vircon32-dialect `int* text` (Vircon32 strings are int[], one 32-bit
// word per character) converted to `char*` - a genuine runtime-
// correctness fix, not just a compile nicety: a raw int* receiving a C
// string literal would reinterpret its bytes as garbage ints. `text[
// charIdx ]` (a char, integer-promoted at the call site) feeds directly
// into jslmFontByte()'s own `int ch` parameter unchanged.
int jslmTextByte( char* text, int textLen, int startX, int x )
{
...
JslmEnemyState jslmEnemyStates[2];
...
int jslmGameOverFreq[3] = { 30, 80, 1, };
int jslmGameOverDur[3]  = { 400, 200, 500, };
int jslmGameOverWaitFrames[3] = { 11, 5, 16, }; // ceil(dur/freqHz * 60), freqHz = 500000/(255-freq)
int jslmGameOverIdx;
int jslmGameOverTimer;

// stage-clear cue (3 notes - matches Sound(50,100);Sound(100,100);Sound(150,300);)
int jslmClearFreq[3] = { 50, 100, 150, };
int jslmClearDur[3]  = { 100, 100, 300, };
int jslmClearWaitFrames[3] = { 3, 2, 4, };
int jslmClearIdx;
int jslmClearTimer;
