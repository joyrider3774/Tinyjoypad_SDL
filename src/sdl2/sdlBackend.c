...
// cglpSDL2.c - a curated 5-state subset (nothing -> pixel-grid+glow ->
...
void md_initVideo()
{
    ...
    if( gScreen )
    {
        ...
        gDarkGrayPixel = SDL_MapRGBA( gScreen->format, 90, 90, 90, 255 );
    }
...
void md_endFrame()
{
    ...
    if( gScreenTexture )
    {
        ...
        {
            SDL_Rect toastRect = { gToastRectX, gToastRectY, gToastRectW, gToastRectH };
            SDL_RenderCopy( gRenderer, gScreenTexture, &toastRect, &toastRect );
        }
    }
