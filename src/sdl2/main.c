...
// portable-sdl's own cglpSDL2.c main()/update(), which is woven into
// crisp-game-lib's own Game/getGame()/highscore-persistence system this
// project has no equivalent of.
//
// This file DOES reuse cglpSDL2.c's own command-line-parameter surface and
...
// title, matching cglpSDL2.c's own ".cgl" stub format exactly) - lets an
...
int main( int argc, char** argv )
{
    ...
    // from Explorer/a shortcut. Unlike cglpSDL2.c's own identical-looking
    ...
    // unconditionally freopen("CON",...)-ing over it (as cglpSDL2.c's own
    ...
    // cglpSDL2.c's own ".cgl" filename-based, not-file-content-based,
